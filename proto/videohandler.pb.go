...
type VideoRequest struct {
	Type                 VideoType `protobuf:"varint,1,opt,name=type,proto3,enum=videohandler.VideoType" json:"type,omitempty"`
...
type StatusResponse struct {
	Status               Status   `protobuf:"varint,1,opt,name=status,proto3,enum=videohandler.Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("videohandler.Status", Status_name, Status_value)
	proto.RegisterEnum("videohandler.VideoType", VideoType_name, VideoType_value)
	proto.RegisterType((*Video)(nil), "videohandler.Video")
	proto.RegisterType((*EncodingVideo)(nil), "videohandler.EncodingVideo")
	proto.RegisterType((*QueuedVideo)(nil), "videohandler.QueuedVideo")
	proto.RegisterType((*VideoRequest)(nil), "videohandler.VideoRequest")
	proto.RegisterType((*VideoResponse)(nil), "videohandler.VideoResponse")
	proto.RegisterType((*CancelEncodingRequest)(nil), "videohandler.CancelEncodingRequest")
	proto.RegisterType((*UpdatePriorityRequest)(nil), "videohandler.UpdatePriorityRequest")
	proto.RegisterType((*StatusResponse)(nil), "videohandler.StatusResponse")
}
...
var fileDescriptor_f718a8b2c1ea4061 = []byte{
	...
	,
}
...
func (c *videoHandlerClient) GetVideos(ctx context.Context, in *VideoRequest, opts ...grpc.CallOption) (*VideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/videohandler.VideoHandler/GetVideos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoHandlerClient) CancelEncoding(ctx context.Context, in *CancelEncodingRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/videohandler.VideoHandler/CancelEncoding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoHandlerClient) UpdatePriority(ctx context.Context, in *UpdatePriorityRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, "/videohandler.VideoHandler/UpdatePriority", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VideoHandler_GetVideos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/videohandler.VideoHandler/GetVideos",
	}
...
func _VideoHandler_CancelEncoding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/videohandler.VideoHandler/CancelEncoding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VideoHandler_UpdatePriority_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/videohandler.VideoHandler/UpdatePriority",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _VideoHandler_serviceDesc = grpc.ServiceDesc{
	ServiceName: "videohandler.VideoHandler",
